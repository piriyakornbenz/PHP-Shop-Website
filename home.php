...
$stmt = $conn->prepare("SELECT * FROM section_home");
$stmt->execute();
...
if (isset($_POST['update'])) {
    try {
        ...
        $updateHome = $conn->prepare("UPDATE section_home SET heading = :heading, sub_heading = :subHeading, description = :description, button = :button WHERE id = :id");
        $updateHome->bindParam(':id', $id);
        $updateHome->bindParam(':heading', $heading);
        $updateHome->bindParam(':subHeading', $subHeading);
...
if (isset($_GET['id'])) {
    try {
        $id = $_GET['id'];
        $delete = $conn->prepare("DELETE FROM section_home WHERE id=$id");
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <script src="./component/sidebar_home.js"></script>
    ...
    <!-- update modal -->
    <script src="./component/update_home.js"></script>
