<?php 
    ...
    if(isset($_POST['update'])) {
        try {
            ...
            $update = $conn->prepare("UPDATE section_reviews SET name = :name, email = :email, message = :message WHERE id = :id");
    ...
    if(isset($_POST['add'])) {
        try {
            ...
            $add = $conn->prepare("INSERT INTO section_reviews(name, email, message) VALUES(:name, :email, :message)");
    ...
    if(isset($_GET['id'])) {
        try {
            $id = $_GET['id'];
            $delete = $conn->prepare("DELETE FROM section_reviews WHERE id=$id");
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <script src="./component/sidebar_reviews.js"></script>
    ...
    <!-- update modal -->
    <script src="./component/update_reviews.js"></script>
    <script src="./component/add_reviews.js"></script>
